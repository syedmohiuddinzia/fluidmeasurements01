...
## Flow Chart
<img src="https://github.com/syedmohiuddinzia/fluidmeasurements01/raw/main/flow.png" alt="Flow Sensor Diagram" height="300">
...
## Installation
1- Connect sensors to arduino mega 2560 as shown on flow chart </br>
2- Upload arduino code on arduino mega 2560 </br>
3- Open the project directoy and open scripty.py 
`` 
python3 script.py
`` </br>
4- To closs press CTRL+C to close the pytohn script </br>
5- New CSV file will be generated in same directory </br>
